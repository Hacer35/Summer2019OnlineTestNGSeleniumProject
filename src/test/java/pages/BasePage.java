...
//everything that id in common among pages
//can go here
//for example top menu elements dont belong to specific page
...
public class BasePage {
    ...
    public BasePage(){
        ...
        //'this' method requires to provide webdriver obj for @FindBy
        //and page class
        //this means this page class
        PageFactory.initElements(Driver.get(), this);
    }
/*
This method below stands for navigation in vytrack
provide tab name, for example "Fleet" as a String
and module name , for example "Vehicles" as a String
